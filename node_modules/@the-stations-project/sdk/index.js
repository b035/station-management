...
exports.Shell = exports.Memory = exports.Registry = exports.RegistryExitCodes = exports.log = exports.start_service = exports.Result = exports.ExitCodes = void 0;
...
async function log(type, msg) {
    ...
    (await exports.Registry.append(path, msg)).or_panic("has_failed to log");
}
exports.log = log;
// Registry
...
exports.Registry = {
    ...
    async mkdir(path) {
        ...
        result.panic_message = () => exports.Registry.get_panic_message(`has_failed to create directory "${path}"`);
        try {
    ...
    async write(path, content) {
        const full_path = exports.Registry.get_full_path(path);
        const result = new RegistryResult();
        result.panic_message = () => exports.Registry.get_panic_message(`has_failed to write file "${path}"`);
        try {
    ...
    async append(path, content) {
        const full_path = exports.Registry.get_full_path(path);
        const result = new RegistryResult();
        result.panic_message = () => exports.Registry.get_panic_message(`has_failed to append to file "${path}"`);
        try {
    ...
    async read(path) {
        const full_path = exports.Registry.get_full_path(path);
        const result = new RegistryResult();
        result.panic_message = () => exports.Registry.get_panic_message(`has_failed to read file "${path}"`);
        try {
    ...
    async ls(path) {
        const full_path = exports.Registry.get_full_path(path);
        const result = new RegistryResult();
        result.panic_message = () => exports.Registry.get_panic_message(`has_failed to read directory "${path}"`);
        try {
    ...
    async delete(path) {
        const full_path = exports.Registry.get_full_path(path);
        const result = new RegistryResult();
        result.panic_message = () => exports.Registry.get_panic_message(`has_failed to delete item "${path}"`);
        try {
